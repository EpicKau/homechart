...
import {
  ...
  WebGlobalAboutWhatsNew,
  WebGlobalActionEndDemo,
  WebGlobalActionSignIn,
  WebGlobalActionSignInChild,
  WebGlobalActionSignOut,
  WebGlobalAdmin,
  WebGlobalAll,
  ...
  WebGlobalFeatureVoting,
  WebGlobalInProgress,
  WebGlobalInstallHomechart,
  WebGlobalInstallHomechartiOS,
  WebGlobalPersonal,
  WebGlobalSent,
  WebGlobalSettings,
...
export const AppMenuComponents: Stream<AppMenuComponent[]> = Stream(
  [] as AppMenuComponent[],
);
...
AuthAccountState.data.map((authAccount) => {
  ...
  AppMenuComponents([
    ...
    },
    {
      ...
      permitted: (): boolean => {
        return (
          GlobalState.permitted(PermissionComponentsEnum.Calendar) &&
          !GlobalState.hideComponentIncludes("Calendar")
        );
      },
      requireOnline: false,
    },
    {
      ...
      permitted: (): boolean => {
        return (
          GlobalState.permitted(PermissionComponentsEnum.Auth) &&
          !GlobalState.hideComponentIncludes("Bookmarks")
        );
      },
      requireOnline: false,
    ...
    },
    {
      ...
      permitted: (): boolean => {
        return (
          GlobalState.permitted(PermissionComponentsEnum.Budget) &&
      ...
      views: Stream([
        ...
        },
        {
          ...
          itemsIconFormatter: (b: AppMenuComponentViewItem): string => {
            switch (b.name) {
              case AuthAccountState.translate(
                WebGlobalBudgetChartsSpendingByCategory,
              ):
        ...
        },
        {
          ...
          countFormatterView: (b: BudgetAccount): string => {
            return Currency.toString(
              b.budgetTransactionAmount,
              AuthHouseholdState.findID(b.authHouseholdID).preferences.currency,
            );
          },
          icon: Icons.More,
          items: BudgetAccountState.data.map(
            (accounts: AppMenuComponentViewItem[]) => {
    ...
    },
    {
      ...
      permitted: (): boolean => {
        return (
          GlobalState.permitted(PermissionComponentsEnum.Cook) &&
    ...
    },
    {
      ...
      permitted: (): boolean => {
        return (
          GlobalState.permitted(PermissionComponentsEnum.Health) &&
      ...
      views: AuthHouseholdState.data.map(() => {
        ...
        if (AuthSessionState.data().permissionsHouseholds !== null) {
          for (const household of AuthSessionState.data()
        ...
        members().push(
          ...AuthHouseholdState.membersChildren().filter((member) => {
        ...
        return [
          ...
          {
            icon: members().length > 1 ? undefined : Icons.HealthItemInput,
            items: members().length > 1 ? members : undefined,
            itemsIcon: members().length > 1 ? Icons.HealthItemInput : undefined,
            link: "/items?type=inputs&",
            name: AuthAccountState.translate(ObjectInputs),
            query: "id",
          },
          {
            icon: members().length > 1 ? undefined : Icons.HealthItemOutput,
            items: members().length > 1 ? members : undefined,
            itemsIcon:
              members().length > 1 ? Icons.HealthItemOutput : undefined,
    ...
    },
    {
      ...
      permitted: (): boolean => {
        return (
          GlobalState.permitted(PermissionComponentsEnum.Inventory) &&
          !GlobalState.hideComponentIncludes("Inventory")
        );
      },
      requireOnline: false,
    ...
    },
    {
      ...
      permitted: (): boolean => {
        return (
          GlobalState.permitted(PermissionComponentsEnum.Notes) &&
          !GlobalState.hideComponentIncludes("Notes")
        );
      },
      requireOnline: false,
      views: Stream([
        ...
        },
        {
          ...
          name: AuthAccountState.translate(WebGlobalPersonal),
          nested: {
            data: NotesPageState.personal as unknown as Stream<
              AppMenuNestedData[]
            >,
            href: (page: NotesPage): string => {
              return `/notes/${
                page.authAccountID === null ? "household" : "personal"
              }/${page.id}`;
            },
            icon: Icons.Notes,
            isCollapsed: (id: NullUUID): boolean => {
              return AuthAccountState.data().collapsedNotesPages.includes(
                `${id}`,
              );
            },
        ...
        },
        {
          ...
          name: AuthAccountState.translate(ObjectHousehold),
          nested: {
            data: NotesPageState.household as unknown as Stream<
              AppMenuNestedData[]
            >,
            href: (page: NotesPage): string => {
              return `/notes/${
    ...
    },
    {
      ...
      permitted: (): boolean => {
        return (
          GlobalState.permitted(PermissionComponentsEnum.Plan) &&
      ...
      views: Stream([
        ...
        },
        {
          ...
          name: AuthAccountState.translate(WebGlobalPersonal),
          nested: {
            data: PlanProjectState.personal as unknown as Stream<
              AppMenuNestedData[]
            >,
            ...
            isCollapsed: (id: NullUUID): boolean => {
              return AuthAccountState.data().collapsedPlanProjects.includes(
                `${id}`,
              );
            },
            onclickCollapse: async (id: NullUUID): Promise<void | Err> => {
        ...
        },
        {
          ...
          name: AuthAccountState.translate(ObjectHousehold),
          nested: {
            data: PlanProjectState.household as unknown as Stream<
              AppMenuNestedData[]
            >,
            findCount: (project: PlanProject): number => {
              return PlanProjectState.findCount(project);
    ...
    },
    {
      ...
      permitted: (): boolean => {
        return (
          GlobalState.permitted(PermissionComponentsEnum.Reward) &&
          !GlobalState.hideComponentIncludes("Reward")
        );
      },
      requireOnline: false,
      views: Stream([
    ...
    },
    {
      ...
      permitted: (): boolean => {
        return (
          GlobalState.permitted(PermissionComponentsEnum.Secrets) &&
          !GlobalState.hideComponentIncludes("Secrets")
        );
      },
      requireOnline: false,
      views: Stream([
        ...
        SecretsVaultState.data().length > 0 &&
    ...
    },
    {
      ...
      permitted: (): boolean => {
        return (
          GlobalState.permitted(PermissionComponentsEnum.Shop) &&
      ...
      views: AuthSessionState.data.map(() => {
        return [
            ...
            items: Stream.lift(
              (_item, payees) => {
                return payees.filter((payee) => {
                  ...
                  return (
                    payee.shopStore === true &&
                    ShopItemState.countItems(payee.id) > 0
                  );
                }) as AppMenuComponentViewItem[];
              },
              ShopItemState.data,
          ...
          },
          {
            ...
            icon: Icons.More,
            items: ShopListState.data as unknown as Stream<
              AppMenuComponentViewItem[]
            >, // eslint-disable-line @typescript-eslint/consistent-type-assertions
    ...
    },
    {
      ...
      views: Stream([
        ...
        {
          icon: Icons.More,
          items: AuthHouseholdState.data as unknown as Stream<
            AppMenuComponentViewItem[]
          >,
    ...
    },
    {
      ...
      permitted: (): boolean => {
        return (
          InfoState.data().featureVotes !== undefined &&
          InfoState.data().featureVotes!.length > 0 &&
          Permission.isPermitted(
            AuthSessionState.data().permissionsHouseholds,
            PermissionComponentsEnum.Auth,
            PermissionEnum.Edit,
      ...
      permitted: (): boolean => {
        return (
          (AppState.isSessionAuthenticated() &&
            AppState.getSessionInstallPrompt() !== null) ||
          /ipad|iphone/.test(navigator.userAgent.toLowerCase())
        );
      },
      requireOnline: false,
    },
